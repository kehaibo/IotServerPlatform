...
TEMPLATES = [
    {
        ...
        'DIRS': ['D:\\development\\python\\devicecnt\\app\\templates','D:\\development\\python\devicecnt\\decive\\templates',
                'D:\\my_app\\python3.6\\Lib\\site-packages\\django\\contrib\\admin\\templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
